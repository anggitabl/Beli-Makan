...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>Beli</strong> Makan</a>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">Warung Beli Makan</h3>
          <h5>Jalan Merdeka Merah Putih
          <br>Buka Jam <strong>06:00 - 18:00</strong></h5>
        </div>
        ...
        <div class="row mb-5 mt-5 ">
          ...
          <div class="col-md-6 d-flex justify-content-start">
            <div class="card bg-dark text-white border-light">
              ...
              <div class="card-img-overlay mt-5 text-center">
               <a href="pesanan.php" class="btn btn-primary">PESANAN</a>
              </div>
            </div>
          </div>
        </div>
