...
<body>
    ...
    <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
            <h1 class="display-4"><span class="font-weight-bold">Beli Makan</span></h1>
            <hr>
    ...
    <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
            <a class="navbar-brand text-white" href="user.php"><strong>Beli Makan</strong> <br>User Page</a>
    ...
    <div class="container">
        <div class="d-flex mt-3">
            <input type="text" id="keyword" class="form-control me-2" placeholder="Cari produk...">
            <button id="cari" class="btn btn-success" disabled>
    ...
    $(document).ready(function() {
        $("#keyword").on("input", function() {
            ...
            $(".card").each(function() {
                var namaProduk = $(this).find(".card-title").text().toLowerCase();
